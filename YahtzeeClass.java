...
//hand need to be sorted to check for straights
	...
	sortArray(hand,DICE_IN_PLAY);System.out.println("Here is your sorted hand : ");for(
	int dieNumber = 0;dieNumber<DICE_IN_PLAY;dieNumber++)
	{
...
//upper scorecard
	for(
	int dieValue = 1;dieValue<=6;dieValue++)
	{
		int currentCount = 0;
